...
static motor_info_holder *holder_ptr;
 ...
 * Return value: void
 * Description:
 * 1) Run the motor's onfiguration function (Read its description)
...
/* This some features In the Drive which I coded and then I didn't need it in this 
 application */
